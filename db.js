                ...
                if (res.length === 0) {
                   ...
                   // displayInventory()
                    ...
                    if (quantity <= productInfo.stock_quantity) {
                        ...
                        var updateQueryStr = "UPDATE products SET stock_quantity = " + (productInfo.stock_quantity - quantity) + " WHERE itemid = " + item
                        ...
                        connection.query(updateQueryStr, function(err, data) {
                            ...
                            console.log(" - - - - - - - - - - - - - - - ")
                            console.log("To shop again with us please input 'node db.js' into your command line again.")
                            console.log("\n")
                        ...
                        setTimeout(function() { showInventory() }, 1000*10)
                    }
